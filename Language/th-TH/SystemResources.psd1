...
'@
    ...
    ParagraphSummary = ตารางต่อไปนี้สรุปกระบวนการของระบบ 10 อันดับแรก สำหรับข้อมูลโดยละเอียดเพิ่มเติม โปรดตั้งค่า InfoLevel.ProcessInfo เป็น 2 ในไฟล์การกำหนดค่ารายงานของคุณ เรียงลำดับตามการใช้งาน CPU
    Heading = กระบวนการ
